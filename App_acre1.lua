...
local description = [[
   Esta aplicação apresenta o gradiente urbano das localidades amostradas por Lana et al. (2017).
   Em 2015, um conjunto de 40 localidades na região do Alto Juruá (Acre) foi caracterizado com base no inquérito realizado em 520 domicílios com o objetivo de valiar o grau de contribuição do domicílio e da localidade para explicar a prevalência local da malária. Os resultados sugeriram um território complexo para o qual uma taxonomia mais complexa que a rural vs. urbana seria útil para classificar áreas com riscos diferentes para a malária. Adotando um modelo de representação da urbanização baseado na perspectiva de um gradiente, essas localidades foram classificadas em termos de paisagem de entorno (Sistema de Objetos) e seu conteúdo social (Sistema de Valores) (Dal'Asta et al., 2018). Além dos dados do inquérito domiciliar, foram utilizados dados de uso e cobertura da terra do TerraClass que permitiram posicionar cada localidade ao longo de um gradiente de intensidades medidas em relação à cidade de Mâncio Lima. Os resultados mostraram que as localidades, oficialmente classificadas como rurais, estão inseridas em contextos que não são essencialmente urbanos ou rurais, corroborando com o argumento de que a estreita relação entre as populações do campo e os centros urbanos é um fenômeno observável em toda a Amazônia.

   Fonte: Lana, R.M.; Riback, T. I. S.; Lima, T. F. M., da Silva-Nunes, M.; Cruz, O. G.; Oliveira, F. G. S.; Moresco, G. G.; Honório, N. A.; Codeço, C. T. Socioeconomic and demographic characterization of an endemic malaria region in Brazil by multiple correspondence analysis. Malar J. 2017;16:1. doi: 10.1186/s12936-016-1650-6.
   Dal'Asta, A.P.; Lana, R.M.; Amaral, S.; Codeço, C.T.; Monteiro, A.M.V. The Urban Gradient in Malaria-Endemic Municipalities in Acre: Revisiting the Role of Locality. Int. J. Environ. Res. Public Health 2018, 15(6), 1254; doi:10.3390/ijerph15061254
   ]]
...
Application{
	...
	villages = View{
		download = true,
		description = "Localidades rurais e urbanas visitadas dos municípios de Mâncio Lima e Rodrigues Alves.",
		select = {"nome", "tipo"},
		icon = {"river", "bigcity", "road", "bigcity"},
		label = {"MLr", "MLu", "RAr", "RAu"},
